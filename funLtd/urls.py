...
urlpatterns = [
    ...
    url(r'^profile/(?P<username>[0-9A-Za-z_\-]+)/$', 'user_auth.views.profile', name='profile'),
    url(r'^about/$', 'user_auth.views.about', name='about'),
    url(r'^support/$', 'user_auth.views.support', name='support'),
]
