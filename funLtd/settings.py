"""
Django settings for funLtd project.
...
SECRET_KEY = '4f-0_s%@n$2h+asavvwd(7nog6iec^hvupk$3*$qqog=-yh67l'
...
WSGI_APPLICATION = 'funLtd.wsgi.application'
